            ...
            <div className={`w-[480px] p-8 rounded-[24px] border ${state.invoice.theme === 'dark' ? 'bg-surface border-primary/20' : 'bg-white border-gray-200 shadow-2xl'}`} onClick={e => e.stopPropagation()}>
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  className={`w-full text-2xl font-black bg-transparent outline-none border-b-2 border-primary pb-2 text-primary tabular-nums ${state.invoice.theme === 'dark' ? '' : ''}`}
                  placeholder="25400"
                  min="1"
                />
